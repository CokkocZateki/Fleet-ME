...
class FleetsApi
{
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFleetsFleetIdMembers($fleet_id, $accept_language = null, $datasource = null)
    {
        list($response) = $this->getFleetsFleetIdMembersWithHttpInfo($fleet_id, $accept_language, $datasource);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFleetsFleetIdMembersWithHttpInfo($fleet_id, $accept_language = null, $datasource = null)
    {
        // verify the required parameter 'fleet_id' is set
        if ($fleet_id === null) {
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFleetsFleetIdWings($fleet_id, $accept_language = null, $datasource = null)
    {
        list($response) = $this->getFleetsFleetIdWingsWithHttpInfo($fleet_id, $accept_language, $datasource);
        return $response;
    }
     ...
     * @throws \Swagger\Client\ApiException on non-2xx response
     */
    public function getFleetsFleetIdWingsWithHttpInfo($fleet_id, $accept_language = null, $datasource = null)
    {
        // verify the required parameter 'fleet_id' is set
        if ($fleet_id === null) {
